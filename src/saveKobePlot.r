# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/src/saveKobePlot.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: saveKobePlotall_the_years) {')
if (!IN_BEMTOOL) {
...
col_kobe <- c("blue", "black", "grey", "dark green", "purple", "blue", "black", "grey", "dark green", "purple")
 plot_title <- paste("KOBE plot -", BMT_SPECIES)
  ...
  SSB_ <- convert_numeric0_to_na(as.numeric(as.character(population_tbl[,6] )))
