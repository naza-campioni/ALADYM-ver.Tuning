# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/src/Discardvector.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: DiscardvectorD_Vector,loca_Length_Average,tr)   {')
...
nyears = length(D_Vector) -1   
    ...
    # et 0, in cui dobbiamo tener conto del tr
