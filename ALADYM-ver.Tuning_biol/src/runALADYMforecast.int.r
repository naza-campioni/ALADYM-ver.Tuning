# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/src/runALADYMforecast.int.r'), '\n')
...
# if (printOK) cat("\n\n")
print("***************************************************************************", quote=FALSE)
print(paste("Launching BEMTOOL biological forecast [ALADYM] for species", BMT_SPECIES[ALADYM_spe], "year", years.forecast[current_year], "xxx"), quote=FALSE)
print("***************************************************************************", quote=FALSE)
cat("\n\n")
if (current_year == 1) {
...
if (current_year == 1) {   # solo il 1anno
...
if (as.numeric(INP$OPT_F_TYPE)==1) { 
try(load_FORECAST(forecast) ,silent=T)
} else {
try(load_FORECAST_entrataF(forecast),silent=T)
}
