# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/src/PlotRecruitment.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: PlotRecruitment) {')
...
plot(recruit_to_plot$Year, recruit_to_plot$Recruitment, main=paste("Recruitment - ",BMT_SPECIES[ALADYM_spe],sep=""),xlab="Years",ylab="thousands",type="b", pch=20, ylim=lim_val, col="blue")    # sono gi in migliaia
...
#lines(loca_xa,meanWequals(Recruitment_with_noise,GLO$L_number + 1, INP$Time_slice),main="Recruitment",xlab="Years",ylab="thousands", lwd=1,col="blue")    # sono gi in migliaia
