# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/src/utilities/meanWequals.r'), '\n')
...
# para_inVect=SRO$Z_calculated
# para_vectLength=End + 1
# para_pointsMean=INP$Time_slice

meanWequals <- function(para_inVect, para_vectLength, para_pointsMean) {
# if (printOK) if (printOK)   print('Calling function: meanWequalspara_inVect, para_vectLength, para_pointsMean) {')
...
try( loca_vect[1] <- para_inVect[1], silent = T)
