# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/src/settings_ref_points.r'), '\n')
...
INP$OPT_SG_TYPE_original<-INP$OPT_SG_TYPE
INP$Discard_original<-INP$Discard 
INP$Type_discard_original<-INP$Type_discard
...
if (all(INP$OPT_SG_TYPE_original[(forecast-INP$Average_forecast*12+1):forecast,g] == INP$OPT_SG_TYPE_original[forecast,g])) {
  for (i in 1:loca_Nsimulation){ 
  INP$Fishing_efforts2[i,g] <-mean(INP$Fishing_efforts[(forecast-INP$Average_forecast*12+1):forecast,g])
  INP$Discard2[i,g] <-ifelse(!is.na(INP$Discard_original[forecast,g]),INP$Discard[1,g],NA)
  ...
  INP$Discard   [i,g]= INP$Discard_original[forecast,g]
  INP$Type_discard  [i,g]= INP$Type_discard_original[forecast,g]                                          # <<----------------------------- NEW
 ...
 for (i in 1:loca_Nsimulation){ 
  ...
  INP$Discard2[i,g] <-INP$Discard_original[forecast,g]
