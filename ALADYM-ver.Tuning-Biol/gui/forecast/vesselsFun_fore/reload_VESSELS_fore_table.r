# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/forecast/vesselsFun_fore/reload_VESSELS_fore_table.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: reload_EMPTY_VESSELS_fore_tablew) {')
                            # fleet.GT_fore
VESSELS_fore <<- list()
VESSELS_foreIndex <<- 0
...
# if (printOK)   print('Calling function: reload_VESSELS_fore_tablew) {')
