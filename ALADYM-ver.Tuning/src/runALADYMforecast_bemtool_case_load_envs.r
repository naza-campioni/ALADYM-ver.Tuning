cat('Running script:', 'runALADYMforecast_bemtool_case_load_envs.r', '\n')
# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/src/runALADYMforecast_bemtool_case_load_envs.r'), '\n')
...
if (BMT_SCENARIO != BMT_HR_CHANGE_FISHMORTALITY )  {     # ----------------------------------------------- different from REDUCTION OF F scenario
    ...
    Ref_year <-  NA 
        ...
        bmt_time_span <- convert_numeric0_to_na(as.numeric(as.character(new_aldForecast@target_year))) - years[length(years)]  #as.numeric(as.character(cfg[rownames(cfg) == "casestudy.HR3",1]))
