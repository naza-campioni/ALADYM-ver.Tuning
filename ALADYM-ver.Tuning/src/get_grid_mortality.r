# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/src/get_grid_mortality.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: get_grid_mortalityMETHOD,Par,VB_CI,lengths,ages,l50,tmax,a,b) { # (INP$FOPT_M_TYPE,INP$FMtmax,INP$VB_gridF,BAS$FLength,BAS$FAge)#INP$MWLa')
if (FALSE){
