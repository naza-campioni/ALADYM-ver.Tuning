# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/forecast/daysFun_fore/reload_DAYS_fore_table.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: reload_EMPTY_DAYS_fore_tablew) {')
                            # fleet.GT_fore
  DAYS_fore <<- list()
  DAYS_foreIndex <<- 0
...
# if (printOK)   print('Calling function: reload_DAYS_fore_tablew) {')
