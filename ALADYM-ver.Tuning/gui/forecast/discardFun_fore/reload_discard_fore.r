# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/forecast/discardFun_fore/reload_discard_fore.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: reload_EMPTY_discard_forew) {')
                            # fleet.GT_fore
discards_fore <<- list()
...
# if (printOK)   print('Calling function: reload_discard_forew) {')
