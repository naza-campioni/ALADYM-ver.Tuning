# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/utilities/interconn.bmt/add_BMT_fleetsegments.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: add_BMT_fleetsegmentsnum_ORD_fleetsegm, num_fleet) {')
...
lands <- convert_numeric0_to_na(as.numeric(as.character(Interactionsyear[[yea]][[ALADYM_spe]]@interactions[[num_ORD_fleetsegm]]$historicalLandings )))
# print(lands)
if (yea==1) {
