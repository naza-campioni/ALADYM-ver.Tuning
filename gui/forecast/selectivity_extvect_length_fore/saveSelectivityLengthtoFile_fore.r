# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/forecast/selectivity_extvect_length_fore/saveSelectivityLengthtoFile_fore.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: saveSelectivityLengthtoFile_forew) {')
...
all_SelectivityLength[all_SelectivityLength$Year == years_forecast[yy] & all_SelectivityLength$Sex == "M", (2+fs) ] <- convert_numeric0_to_na(as.numeric(as.character(dataframe_F_M[, yy+1])))
all_SelectivityLength[all_SelectivityLength$Year == years_forecast[yy] & all_SelectivityLength$Sex == "F", (2+fs) ] <- convert_numeric0_to_na(as.numeric(as.character(dataframe_F_F[, yy+1])))
 }
}
