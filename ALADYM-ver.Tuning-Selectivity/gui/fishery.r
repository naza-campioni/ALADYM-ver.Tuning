# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/fishery.r'), '\n')
...
n_ages_males <- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(Populations[[ALADYM_spe]]@lifespan[1,1]))))
first_age_mal <- 0
# {
...
n_ages_females <- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(Populations[[ALADYM_spe]]@lifespan[2,1]))))
first_age_fem <- 0
#} 
