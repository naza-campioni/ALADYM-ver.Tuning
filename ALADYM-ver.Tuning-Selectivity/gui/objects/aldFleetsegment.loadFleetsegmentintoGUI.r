# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/objects/aldFleetsegment.loadFleetsegmentintoGUI.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: loadFleetsegmentintoGUIobject) {')
...
fleet.discard[,3] <- convert_numeric0_to_na(as.numeric(as.character( fleet.discard[,3])))
fleet.discard[,4] <- convert_numeric0_to_na(as.numeric(as.character( fleet.discard[,4])))
