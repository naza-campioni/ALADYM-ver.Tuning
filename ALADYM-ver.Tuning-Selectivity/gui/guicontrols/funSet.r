# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/guicontrols/funSet.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: set_survivability_C_malesw) {')
...
# if (printOK)   print('Calling function: set_survivability_C_males_forew) {')
...
# if (printOK)   print('Calling function: set_survivability_C_femalesw) {')
...
# if (printOK)   print('Calling function: set_survivability_C_females_forew) {')
...
# if (printOK)   print('Calling function: set_survivability_OGIVE_param1w) {')
...
# if (printOK)   print('Calling function: set_survivability_OGIVE_param1_forew) {')
...
# if (printOK)   print('Calling function: set_survivability_OGIVE_param2w) {')
...
# if (printOK)   print('Calling function: set_survivability_OGIVE_param2_forew) {')
...
# if (printOK)   print('Calling function: change_survivability_DISCARD_param1_malesw) {')
...
# if (printOK)   print('Calling function: change_survivability_DISCARD_param1_males_forew) {')
...
# if (printOK)   print('Calling function: change_survivability_DISCARD_param2_femalesw) {')
...
# if (printOK)   print('Calling function: change_survivability_DISCARD_param2_females_forew) {')
} else {
