# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/fishery/effort.fishingeffortFun/exportFishingCoefficienttoFile.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: exportFishingCoefficienttoFilew) {')
...
colnames(proddata_table) <- heading
 ...
 years_rep <- rep(years, 12)
   ...
   proddata_table$FISHING_COEFFICIENT <- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(fact_mat[,fs]))))
