# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/fishery/fisheryFun/fact_calc.gui.r'), '\n')
...
coeff_a <- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(EFF_F_options$a[jea])))) 
coeff_b <- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(EFF_F_options$b[jea])))) 
