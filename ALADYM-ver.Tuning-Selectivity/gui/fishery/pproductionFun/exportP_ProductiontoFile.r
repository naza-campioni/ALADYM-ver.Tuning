# if (printOK) if (printOK) cat('Sourcing file: ', basename('C:/Users/emant/Downloads/stecf_tech_measures-main3/stecf_tech_measures-main/BEMTOOL2.5/code/src/biol/bmtALADYM/ALADYM-ver12.3-2017_0501/gui/fishery/pproductionFun/exportP_ProductiontoFile.r'), '\n')
...
# if (printOK) if (printOK)   print('Calling function: exportP_ProductiontoFilew) {')
...
colnames(proddata_table) <- heading
 ...
 years_rep <- rep(years, 12)
   ...
   proddata_table$P_PRODUCTION <- convert_numeric0_to_na(as.numeric(as.character(convert_numeric0_to_na(p_production_mat[,fs]))))
